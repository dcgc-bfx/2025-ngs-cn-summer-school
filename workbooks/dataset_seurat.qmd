...
our_colours = c("#Fa1a8e", "#009B7D", "#ff9933", "#7083a4", "#ffce45", "#015e05", "#fedf25","#d2b48c", "#bb55e1", "#6ec5ab", "#5d57af", "#143341", "#761445", "#d65b5a", 
...
```{r}
filtered_bins_genes = WhichCells(sc, expression = nFeature_RNA.008um > 2000)
