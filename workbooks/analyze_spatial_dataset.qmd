...
Finally, we create a Seurat object that only includes the bins that are in the cortex region:
...
The cortex object still contains ~200,000 bins. For computational efficiency, we will sketch the cortex object to reduce the number of bins to 50,000 followed by variable feature selection, data scaling and PCA dimensionality reduction.
