...
To make the analysis computationally manageable, we sketch the dataset down to 10,000 bins for this tutorial, then perform standard scaling and PCA:
...
```{r}
# Maybe do not run but precompute and let them load it?
