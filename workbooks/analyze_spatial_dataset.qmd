...
The cortex object still contains ~200,000 bins. For computational efficiency, we will sketch the cortex object to reduce the number of bins to 50,000 followed by data scaling and PCA dimensionality reduction.
